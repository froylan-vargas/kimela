  ...
  return (
    <Html>
      <Section>
        ...
        <Text>
          Recibimos una solicitud para restablecer tu contraseña en qimela.
        </Text>
        <Button href={resetUrl}>Restablecer contraseña</Button>
        <Text>
          Este enlace expira en 1 hora. Si no solicitaste esto, ignora este
          correo.
        </Text>
      </Section>
    </Html>
...
): Promise<string> => render(<PasswordResetEmail {...props} />);
