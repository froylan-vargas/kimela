...
describe('InviteController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: GenerateInviteTokenUseCase, useValue: { execute: jest.fn() } },
        { provide: RevokeInviteTokenUseCase, useValue: { execute: jest.fn() } },
        { provide: GetQimelaByInviteTokenUseCase, useValue: { execute: jest.fn() } },
        { provide: SubscribeViaInviteTokenUseCase, useValue: { execute: jest.fn() } },
