# UI, a user is logged in into the system

I want to focus on the first screen the user sees after login.
I need your support imagining an intuitive ui design, be very creative an modern, use the latest ui trends.
...
- Use mock data to create the ui design, don't use real data from the database. Data is not important yet, only design.
- Dont use dark colors use white as base with 1 or 2 more calid colors. (I suggest yellow)
