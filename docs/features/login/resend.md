...
5. _(Optional for Dev, Required for Prod)_ Navigate to the **Domains** section.
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Gracias por registrarte en qimela. Por favor, confirma tu correo
          ...
          <Text style={text}>
            Este enlace expirará en 24 horas. Si no creaste una cuenta, puedes
            ignorar este correo con total tranquilidad.
          </Text>
        </Container>
      </Body>
    </Html>
...
export class ResendEmailService implements EmailService {
  ...
  async sendVerificationEmail(
    ...
    const htmlBody = await render(VerificationEmail({ name, confirmUrl }));
